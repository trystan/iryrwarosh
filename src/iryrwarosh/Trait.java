...
public enum Trait {
	...
	EXTRA_HP("healty"), EXTRA_ATTACK("strong"), EXTRA_EVADE("evasive"),EXTRA_DEFENSE("shelled"),
	...
	DEFLECT_RANGED("deflects"), SPELL_CASTER("spellcaster"), HUNTER("hunter"), MYSTERIOUS("mysterious");
